 ...
 <!-- Main Header -->
    <header class="main-header header-style-one">
        ...
        <div class="header-upper">
            <div class="auto-container">
                <div class="inner-container">
                    <!--Logo-->
                    <div class="logo-box">
                        <div class="logo"><a href="index.php"><img src="assets/images/rclogo.png" alt=""width="81" height="81"></a></div>
                    </div>
                    <div class="right-column">
                        <!--Nav Box-->
                        <div class="nav-outer">
                            ...
                            <nav class="main-menu navbar-expand-md navbar-light">
                                <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                    <ul class="navigation">
                                        ...
                                        <li class="dropdown"><a href="member.php">Our Team</a>
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="index.php"><img src="assets/images/rclogo.png" alt=""width="81" height="81" title=""></a></div>
                <div class="menu-outer"><!--Here Menu Will Come Automatically Via Javascript / Same Menu as in Header--></div>
				<!--Social Links-->
				<div class="social-links">
					<ul class="clearfix">
						<!-- <li><a href="#"><span class="fab fa-twitter"></span></a></li> -->
						<li><a target="blank" href="<?php echo $setting['facebook']; ?>"><span class="fab fa-facebook-square"></span></a></li>
						<!-- <li><a href="#"><span class="fab fa-pinterest-p"></span></a></li> -->
						<li><a target="blank" href="<?php echo $setting['instagram']; ?>#"><span class="fab fa-instagram"></span></a></li>
