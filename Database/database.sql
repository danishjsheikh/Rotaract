...
INSERT INTO `events` (`id`, `title`, `category`, `descrip`, `img`, `url`, `date`, `status`) VALUES
...
(2, 'What is included in your member?', 'qual blame belongs to those who fail in their duty through weaknes of will which is the same as saying through shrinking from toil and\r\npain. These cases are perfectly simple and easy to distinguish.', '0'),
...
(28, 'portrait-woman-customer-member-worker.jpg', '2020-12-03 16:12:51', '1'),
...
INSERT INTO `members` (`id`, `title`, `short`, `descrip`, `img`, `url`, `date`, `status`) VALUES
(36, 'Import and Export members', 'We Offer Import & Export assistance foreign businesses in transporting and selling their products in China, India and USA.', '<p open=\"\" sans\",=\"\" arial,=\"\" sans-serif;=\"\" font-size:=\"\" 14px;\"=\"\" style=\"margin-right: 0px; margin-bottom: 15px; margin-left: 0px; padding: 0px; border: none; outline: none; line-height: inherit;\">We Offer Import &amp; Export assistance foreign businesses in transporting and selling their products in China, India and USA.&nbsp;&nbsp;Most of our channel partner are based into USA, India and China.<br></p>', '544420236news-16.jpg', NULL, 'Mon 08 Feb 2021', '0'),
(37, 'Logistic members', 'We are one of the best serving logistics company. Here, the clients get real-time pricing. The price for logistics transport member from USA, Canada, India & China', '<p open=\"\" sans\",=\"\" arial,=\"\" sans-serif;=\"\" font-size:=\"\" 14px;\"=\"\" style=\"margin-right: 0px; margin-bottom: 15px; margin-left: 0px; padding: 0px; border: none; outline: none; line-height: inherit;\">We are one of the best serving logistics company. Here, the clients get real-time pricing. The price for logistics transport member from USA, Canada, India & China with shipping facilities with on-time deliveries in all the major areas around the country.Â <br></p>', '778861706project-16.jpg', NULL, 'Mon 08 Feb 2021', '0'),
(38, 'Home Delivery members', 'We offer Home delivery member member, the basic members for handling deliveries in express and cargo mode globally.', '<p open=\"\" sans\",=\"\" arial,=\"\" sans-serif;=\"\" font-size:=\"\" 14px;\"=\"\" style=\"margin-right: 0px; margin-bottom: 15px; margin-left: 0px; padding: 0px; border: none; outline: none; line-height: inherit;\">We offer Home delivery member member, the basic members for handling deliveries in express and cargo mode globally. There are two members offered under this: Domestic Express members for delivering documents and small parcels.&nbsp; And Big container &amp; shipment members.<br></p>', '189322611project-8.jpg', NULL, 'Mon 08 Feb 2021', '0');
