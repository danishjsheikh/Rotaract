...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! eve */ "./node_modules/eve-raphael/eve.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(eve) {
    ...
    var toHex = function (color) {
        if (R.vml) {
            // http://dean.edwards.name/weevents/2009/10/convert-any-colour-value-to-hex-in-msie/
            var trim = /^\s+|\s+$/g;
            var bod;
            try {
    ...
    // Firefox <3.6 fix: http://webreflection.eventsspot.com/2009/11/195-chars-to-help-lazy-loading.html
